...
<body id="Body">
	...
	<form action="DisplayProcessingFees.php" autocomplete="off" enctype="multipart/form-data" method="post" name="Form"  style="height: 100%;">
...
<div align="center">
   ...
   <tr>
									...
									<td class="heading" colspan="3">Search Processing Fees</td>
								...
								<td>Processing Fees</td>
									...
									<select id="PF" name="PF" class="form-control border-input"  >
