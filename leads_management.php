...
<body id="Body">
	...
	<form action="display_registered_details.php" autocomplete="off" enctype="multipart/form-data" method="post" name="Form"  style="height: 100%;">
	...
	<?php include('./common/bootstrap_common_mainmenu.php'); ?>
					...
					<table align="center"><tr><td height="50"></td></tr>
									...
									<td>
										...
										<input name="fromdate" id="fdate6" size="40" class="form-control border-input"  type="text" value="<?php echo $fromdate; ?>"  onclick="displaydate('#fdate6')"></td>
									...
									<input name="todate" id="tdate6" size="40" class="form-control border-input"  type="text" value="<?php echo $current_date; ?>"  onclick="displaydate('#tdate6')" ></td>
								...
								<tr>
									...
									<input name="referenceID"  class="form-control border-input" placeholder="Reference ID" size="40" type="text"></td>
									...
									<td>:</td>
									<td>
									<input name="mobile"  id="mobile" class="form-control border-input" placeholder="Mobile" size="40" maxlength="10" type="text"></td>
								</tr>
                                                                <tr>
									<td>Email</td>
									<td>:</td>
									<td>
									<input name="email"  id="email" class="form-control border-input" placeholder="Email" size="40" type="text"></td>
								</tr>
                                 ...
                                 <tr><td>&nbsp;</td></tr>                            
									...
									<input name="submit" style="font-size:16px" type="submit" value="Search"></td>
