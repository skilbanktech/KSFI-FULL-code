    ...
    <table align="center" border="0" cellpadding="3" cellspacing="0" width="650">
		...
		<?php } ?>
                  ...
                  <tr>
                            ...
                            <input id="amount" readonly="readonly"  maxlength="7" name="amount" size="40" type="text"  value="<?php if($row) { echo $fetch['amount']; } ?>"></td>
					...
					<tr>
                           ...
                           <option <?php 
                            ...
                            <td> 
							<select id="vehicleloanType" disabled="disabled" name="vehicleloanType" size="1" <?php if($fetch['typeofLoan'] != 'Vehicle Finance') { ?> disabled='disabled'  <?php } ?>>
