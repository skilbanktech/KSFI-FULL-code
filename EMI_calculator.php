        ...
        var emi1 = loanAmount * rate * (Math.pow(1 + rate, term) / (Math.pow(1 + rate, term) - 1));
		 ...
		 var emi= Math.round(emi1);
			...
			//	var emi = ((loanAmount * monthlyInterestRatio) * sp);
				...
				var detailDesc = "<thead><tr class='success'><th>Months</th><th>Loan Amount</th><th>EMI</th><th>Principal</th><th>Interest</th><th>Outstanding Amount</th></thead><tbody>";
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="box">
								...
								<div class="col-md-7">
									...
									<input type="text"   data-slider="true" value="25000" data-slider-range="10000,1000000" data-slider-step="5000"  id="la">
									...
									<input type="text" data-slider="true" value="36" data-slider-range="6,84" data-slider-step="3" data-slider-snap="true" id="nm">
									
								
								
								
									<h4><span class="label label-danger" style="font-size:14px">Rate of Interest [ROI] is <strong><span class =''  id="roi_value">10</span></strong></span> </h4>
									<input type="text" data-slider="true" value="10%" data-slider-range="8,33" data-slider-step="1" data-slider-snap="true" id="roi">
									<br>
