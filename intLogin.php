...
<body id="Body"  onload="popup()">
	...
	<form id="Form" action="send_internalLogin.php" autocomplete="off" enctype="multipart/form-data" method="post" name="Form" onsubmit="return validateLoginFormOnSubmit(this)" style="height: 100%;">
		<noscript></noscript>
<div align="center">
<?php  include_once('./common/bootstrapcomHeader.php'); ?>
 ...
 <div class="container" align="center">
      ...
      <div class="form-group">
        <div class="col-md-06">Login Details</div></div></div>
		
		
		<div class="row">
      <div class="form-group">
        <div class="col-md-06">
									<input name="email" style="border-radius:4px; padding: 5px ; "  placeholder="Username/Email" size="35" type="text">	
      ...
      <div class="form-group">
		...
		<?php if($_GET['Role']=='Partner') { ?>						
		<div class="row">
        <div class="form-group">
        <div class="col-md-06">
									New Partner?<a href="partnerregister.php"> Sign up now </a>
								</div></div></div></div>
		<?php   } ?>                               <input type="hidden" name="UserRole" value="<?php echo $_GET['Role']; ?>" />
