    ...
    $select_query= "Select * from institute_partnerdetails where  employee_id='$employee_id' and course_id='$course_id'";
	...
	$sql="update  institute_partnerdetails  set college='$college' ,unversity='$unversity', coursetitle_name='$coursetitle_name' ,course_name='$course_name' ,course_type='$course_type',course_duration_months='$course_duration_months',course_duration_years='$course_duration_years',
	...
	else
	{
		 ...
		 $sql="insert into institute_partnerdetails (employee_id,college,university,coursetitle_name ,course_name ,course_type,course_duration_months,course_duration_years,sessions_of_program,conditional_offer_beforetraining,conditional_offer_companyname,
    unconditional_offer_beforetraining ,unconditional_offer_companyname,corporate_tieup,corporate_tieup_companyname ,industry_type,
	other_industrytype,nsdc_approval ,location_number ,company_location ,other_companylocation,previous_recruited_companies,
	jobskill_type,monthly_salary,newtraining_program,newtrainingprogram_years,students_trained,students_placed,
	basic_qualification,degree_qualification,other_degree_qualification,masters_education,other_master_education,eligibility_test,test_name,written_test,
    personal_interview,group_discussion,previous_academic_percentage,cutoff_percentage,tution_fees,examination_fees,studymaterials_cost,
	travelling_expenses,transportation_expenses,owner_training_experience,owner_trainingexperience_years,
		corporate_driven_institute,updatedby,corporate_driveninstitute_years,owner_industry_experience,
		owner_industryexperience_years,owner_course_experience,owner_courseexperience_years,NSDC_standard_content,
    institute_inhouse,industry_approved_content,trainers_qualification,delivery_model,created)

       	values 
  
  ('$employee_id','$college','$university','$coursetitle_name ','$course_name ','$course_type','$course_duration_months','$course_duration_years','$sessions_of_program',
     '$conditional_offer_beforetraining','$conditional_offer_companyname',
     '$unconditional_offer_beforetraining','$unconditional_offer_companyname','$corporate_tieup',
	'$corporate_tieup_companyname','$industry_type','$other_industrytype','$nsdc_approval','$location_number','$company_location',
	'$other_companylocation','$previous_recruited_companies',
	'$jobskill_type','$monthly_salary','$newtraining_program','$newtrainingprogram_years',
	'$students_trained','$students_placed','$basic_qualification',
	'$degree_qualification','$other_degree_qualification','$masters_education','$other_master_education','$eligibility_test',
	'$test_name','$written_test','$personal_interview','$group_discussion','$previous_academic_percentage','$cutoff_percentage','$tution_fees','$examination_fees','$studymaterials_cost',
	'$travelling_expenses','$transportation_expenses','$owner_training_experience','$owner_trainingexperience_years',
	'$corporate_driven_institute','$updatedby','$corporate_driveninstitute_years','$owner_industry_experience','$owner_industryexperience_years','$owner_course_experience','$owner_courseexperience_years','$NSDC_standard_content',
  '$institute_inhouse','$industry_approved_content','$trainers_qualification','$delivery_model',Now())";
      ...
      mysql_query($sql);
		...
		echo '<script>window.location.href="read_Training_Institutedetails.php"</script>';			
