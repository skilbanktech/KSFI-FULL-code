...
<noscript></noscript>
<div align="center">
	<form id="Form" action="updatePDCheckDetail.php" autocomplete="off" enctype="multipart/form-data" method="post" name="Form" onsubmit="return validatePDCCheckDetailForm(this)" style="height: 100%;">
				...
				<tr>
					...
					<table border="0" cellpadding="0" cellspacing="0" width="978">
						...
						<tr>
							...
							<img alt="KSF Logo" src="js/images/img2.gif"> </td>
	...
	if($row){   
	$col = array('check_id','reference_id','amount','checkno','bankname','branchname','ifsccode','branchaddress','presentationdate','presentationstatus','clearingstatus','docname');
...
<?php } ?>
					...
					<tr><td height="20" colspan="2"></td></tr>
								...
								<td height="10"><input maxlength="6" name="amount" id="amount" type="text" 
								...
								<td style="height: 10px"><select id="payType" name="payType" size="1" onchange="return onSelectedIndexChangeCheque(this,'checkNo','bankname','branchname','ifsccode','branchadd')">
                            ...
                            <option <?php if($row){
								...
								<tr><td class="servicesText">Check No.</td>
									...
									value="<?php if($row) { echo $fetch['checkno']; } ?>"></td></tr>
									
								<tr><td style="height: 17px">
									Bank Name</td><td style="height: 17px">
									<input maxlength="50" name="bankname" id="bankname" type="text"
									value="<?php if($row) { echo $fetch['bankname']; } ?>"></td></tr>
								<tr><td>
									Branch Name</td><td>
									<input maxlength="50" name="branchname" id="branchname" type="text"
									value="<?php if($row) { echo $fetch['branchname']; } ?>"></td></tr>
								<tr><td>
									IFSC Code</td><td>
									<input maxlength="10" name="ifsccode" id="ifsccode" type="text"
									value="<?php if($row) { echo $fetch['ifsccode']; } ?>"></td></tr>
								<tr><td>
									Branch Location</td><td>
									<input maxlength="100" name="branchadd" id="branchadd" type="text"
									value="<?php if($row) { echo $fetch['branchaddress']; } ?>"></td></tr>
								...
								<tr><td>
									...
									<input maxlength="50" name="PresentationStatus" id="PresentationStatus" type="text"
									value="<?php if($row) { echo $fetch['presentationstatus']; } ?>"></td></tr>
								<tr><td>
									Clearing Status</td><td>
									<input maxlength="50" name="ClearingStatus" id="ClearingStatus" type="text"
									value="<?php if($row) { echo $fetch['clearingstatus']; } ?>"></td></tr>
								<tr><td>
									Upload Image</td><td>
