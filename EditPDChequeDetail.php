...
<noscript></noscript>
<div align="center">
	<form id="Form" action="updatePDChequeDetail.php" autocomplete="off" enctype="multipart/form-data" method="post" name="Form" onsubmit="return validatePDCCheckDetailForm(this)" style="height: 100%;">
...
<?php } ?>
					...
					<tr><td height="20" colspan="2"></td></tr>
								...
								<td style="height: 10px"><select id="payType" name="payType" size="1" onchange="return onSelectedIndexChangeCheque(this,'CashDepositedBy','checkNo','ifsccode','file')">
                            ...
                            <option <?php if($row){
                             ...
                             <option <?php if($row){
								...
								<input maxlength="18" name="accountNo" id="accountNo" type="text" 
