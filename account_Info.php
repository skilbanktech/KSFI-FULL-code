...
?>
					...
					<tr><td height="50"></td></tr>
								<tr>
									<td class="heading" colspan="3">Account Details</td>
									</tr>
								...
								<tr>
									...
									<td>:</td>
									<td>
									<?php echo $_SESSION['internal_email']; ?></td>
									<td>
									<a href="change_emailid.php"><img width="20px" src="./images/edit.png">Edit</img></a>
									</td>
								</tr>
