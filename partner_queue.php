...
<div align="center">
	<form id="Form"  autocomplete="off" enctype="multipart/form-data" method="post" name="Form" style="height: 100%;">
		<?php include('./common/common_mainmenu.php'); ?>
					...
					<table width="100%"><tbody><tr><td height="20" class="heading" >Partner Details</td></tr></tbody></table>
	...
	//session_start();
		...
		//if($createuser!=""){
                $select_query="select * from login_details where activeStatus='0'" ;          //  echo $select_query;
		//}
...
<div id="pageNavPosition" align="center"> </div>
			...
			<input name="btnBack" type="button" value="Back" onclick="location.href='searchStatus.php'" /></td> -->
                           ...
                           value='Back' onclick="setaction('searchStatus.php');"></input>
                                ...
                                <input   name="btnActivate" type="submit" onclick="setaction('activateuser_account.php');" 
								disabled="disabled" value="Activate">
                           ...
                           <input type='submit' name="btnModify" value='Modify User' disabled="disabled"
						   onclick="setaction('ModifyUserDetail.php');"></input>                       
