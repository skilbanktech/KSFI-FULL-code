 ...
 <?php if($otherloans=='No')   
	...
	<?php } else  { ?>
	 <li><a href="#tabs-2">Loan Details</a></li>
	  <li><a href="#tabs-3">Collateral Details</a></li>
	<?php } ?>
		  ...
		  <table id="form" align="center" border="0" cellpadding="3" cellspacing="0" width="800">
				  ...
				  <?php } ?>
					...
					<tr>
                            ...
                            <input id="adharcardno" name="adharcardno"  maxlength="12" size="40" type="text"></td>

                    </tr>
					 <?php } ?>
					 <?php if($fetchinfo['PAN_No']=='YES') { ?>
					<tr>
                   ...
                   <?php } ?>
					...
					<?php } ?>
					<?php if($fetchinfo['per_Street1']=='YES') { ?>
                    <tr>
                    ...
                    <tr>
                            ...
                            <td>
                                 <select    id="per_stateSelect"  name="per_state" size="1"></select>
                    ...
                    <tr>
                           ...
                           <select id="per_citySelect"    name="per_city" size="1" >
    ...
    <table align="center" border="0" cellpadding="3" cellspacing="0" width="650">
          ...
          <?php if($otherloans=='No')
                    ...
                    <tr>
                        ...
                        <td>
                                ...
                                <input style="display:none" disabled="disabled" id="ColcountrySelect1" name="Colcountry1" size="20" type="text" onChange="changeState(this,'ColcountrySelect1','ColstateSelect1','ColcitySelect1','ColcountrySelect','ColstateSelect','ColcitySelect');" >
                    ...
                    <tr>
                            ...
                            <td>
                                ...
                                <input id="ColstateSelect1" style="display:none" disabled="disabled" name="Colstate1" size="20" type="text" onChange="changeState(this,'ColcountrySelect1','ColstateSelect1','ColcitySelect1','ColcountrySelect','ColstateSelect','ColcitySelect');">
                    ...
                    <tr>
                            ...
                            <input id="ColcitySelect1" style="display:none" disabled="disabled" name="Colcity1" size="20" type="text" onChange="changeState(this,'ColcountrySelect1','ColstateSelect1','ColcitySelect1','ColcountrySelect','ColstateSelect','ColcitySelect');">
                    ...
                    <tr>
                            ...
                            <input  placeholder="STD Code" id="Colstdcode" maxlength="6" name="Colstdcode" size="10" type="text" onchange="onchangeStdcode(this)">

                            <input id="Colphone" maxlength="8" placeholder="Enter 8 digits" name="Colphone" size="24" type="text" onchange="onchangePhone(this)"></td>
		...
		<?php } ?>
                  ...
                  <tr>
                            ...
                            <input id="amount" maxlength="7" name="amount" size="40" type="text" onclick="subtractionoftwofields('totalfees','SelfContribution','amount')" onfocus="subtractionoftwofields('totalfees','SelfContribution','amount')"  value="<?php if($row) { echo $fetch['amount']; } ?>"></td>
					...
					<tr>
                            ...
                            <td>SelfContribution/Marginmoney </td>
							...
							onchange="additionoftwofields('SelfContribution','amount','totalfees')" onclick="subtractionoftwofields('totalfees','amount','SelfContribution')"
					...
					<tr>
                            ...
                            <td> 
							<select id="typeofLoan" name="typeofLoan" size="1" onchange="return onchangetypeofLoan(this);">
                           ...
                           <option <?php 
                            ...
                            <td> 
							<select id="vehicleloanType" name="vehicleloanType" size="1" <?php if($fetch['typeofLoan'] != 'Vehicle Finance') { ?> disabled='disabled'  <?php } ?>>
                    ...
                    <td>
                            ...
                            <input id="workYes" name="work" type="radio" value="Yes" onclick="onSelectedAppEmployment(this,false)">Yes

                            <input id="workNo" name="work" type="radio" value="No" checked="checked" onclick="onSelectedAppEmployment(this,true)">No</td>
                    ...
                    <tr>
                            ...
                            <select id="employment" disabled="disabled" name="employment" size="1"  onchange="return onSelectedIndexChange(this,'employment_other')">
                            ...
                            </select><select id="employment_other" disabled="disabled" name="employment_other" size="1">
                    ...
                    <tr>
                            ...
                            <input id="business" name="business" maxlength="150" size="40" type="text" disabled="disabled"></td>
                    ...
                    <tr>
                            ...
                            <input id="designation" maxlength="50" name="designation" size="40" type="text" disabled="disabled"></td>
					...
					<tr>
                            ...
                            <select id="yearsInEmployement" name="yearsInEmployement" size="1" disabled="disabled">
                    ...
                    <tr>
                            ...
                            <td><input  maxlength="5"   id="income" name="income"  disabled="disabled" size="40"> </td>
                    ...
                    <tr>
                            ...
                            <input id="bankbal" maxlength="6" name="bankbal" size="40" type="text" disabled="disabled"></td>
                    ...
                    <tr>
                            ...
                            <input id="Empaddress" maxlength="45" name="Empaddress" size="40" type="text" disabled="disabled"></td>
                    ...
                    <tr>
                            ...
                            <input id="Empstreet1" maxlength="45" name="Empstreet1" size="40" type="text" disabled="disabled"></td>
                    ...
                    <tr>
                            ...
                            <input id="Empstreet2" maxlength="45" name="Empstreet2" size="40" type="text" disabled="disabled"></td>
                    ...
                    <tr>
                            ...
                            <td><select id="EmpstateSelect"  name="Empstate" size="1" disabled="disabled">
                    ...
                    <tr>
                            ...
                            <td><select id="EmpcitySelect"  name="Empcity" size="1" disabled="disabled">
                    ...
                    <tr>
                            ...
                            <input id="Emppincode" maxlength="6" name="Emppincode" size="40" type="text" disabled="disabled"></td>
                    ...
                    <tr>
                            ...
                            <input id="Empstdcode"  placeholder="STD Code" maxlength="6" name="Empstdcode" size="10" type="text" disabled="disabled">

                            <input id="Empphone"  placeholder="Enter 8 digits" maxlength="8" name="Empphone" size="24" type="text" disabled="disabled"></td>
		   ...
		   <?php } ?>
                ...
                <?php if($fetchinfo1['Pincode']=='YES') { ?>
                    ...
                    <tr>
                            ...
                            <td>
                                 <select    id="cper_stateSelect"  name="cper_state" size="1"></select>
                    ...
                    <tr>
                           ...
                           <select id="cper_citySelect"    name="cper_city" size="1" >
               ...
               <?php } ?>
                ...
                <?php if($fetchinfo1['Gross_Monthly_Income']=='YES') { ?>
                    <tr>
                            ...
                            <td><input  maxlength="6"   id="cincome" name="cincome"  size="40"></td>
                ...
                <?php if($fetchinfo1['Average_Monthly_Bank_Balance_for_Last_3_months']=='YES') { ?>
                    ...
                    <tr><td colspan="3"><div id="coborrower2_panel" style="display:none"><table>
                   ...
                   <?php } ?>
                    ...
                    <tr>
                            ...
                            <td>
                                 <select    id="coper_stateSelect"  name="coper_state" size="1"></select>
                    ...
                    <tr>
                           ...
                           <select id="coper_citySelect"    name="coper_city" size="1" >
                  ...
                  <?php } ?>
                    ...
                    <tr>
                            ...
                            <td><input  maxlength="6"   id="coincome" name="coincome"  size="40"></td>
                                    ...
                                    <tr>
									 ...
									 <tr>
										  ...
										  'coGoldOrnamentsvalue','coVehiclesSelfOwnedvalue','coOtherAssetsvalue')" name="coVehiclesSelfOwnedvalue" id="coVehiclesSelfOwnedvalue" readonly="readonly"  type="text"></td>
                                            ...
                                            <input type="checkbox"  value="yes"  onclick="CheckAsssetsAmountEntered('coVehiclesSelfOwnedvalue',this)" disabled="disabled" name="coVehiclesSelfOwnedCollateral" id="coVehiclesSelfOwnedCollateral"></td>
