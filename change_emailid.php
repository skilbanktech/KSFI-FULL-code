...
<noscript></noscript>
<div align="center">
	<form id="changeEmail" action="send_changeEmail.php" autocomplete="off" enctype="multipart/form-data" method="post" name="Form" onsubmit="return validateChangePasswordOnSubmit(this)" style="height: 100%;">
	<?php  include_once('./common/bootstrap_common_mainmenu.php'); ?>

           <div class="container" align="center">
		<div class="row">
      <div class="form-group">
        <div class="col-md-06" style="font-size:16px">Change Email </div></div></div>
		
		
		<div class="row">
      <div class="form-group">
        <div class="col-md-06">
				<input name="email" size="40" style="border-radius:4px; padding: 5px ; " type="text"  placeholder="Email" readonly="readonly" value="<?php echo $_SESSION['username'];?>"> 
      ...
      <div class="form-group">
        <div class="col-md-06">
						<input name="newemail" style="border-radius:4px; padding: 5px ; " size="40" type="newemail" placeholder="New Email">
				</div></div></div>
				<div class="row">
      <div class="form-group">
        <div class="col-md-06">
